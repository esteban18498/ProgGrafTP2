...
Shader "Floor"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color11 = IsGammaSpace() ? float4(0.03529411,0.1012738,0.3098039,0) : float4(0.002731742,0.01022164,0.07818743,0);
			float time13 = 5.0;
			...
			float4 color15 = IsGammaSpace() ? float4(0.1294118,0.1469503,0.3490196,0) : float4(0.01520851,0.01891389,0.09989874,0);
...
/*ASEBEGIN
Version=18900
883;73;581;580;1699.604;704.314;1.594623;False;False
...
ASEEND*/
//CHKSM=7F27A5B9C0D619974DD4170AE22D7BF30D0B745D