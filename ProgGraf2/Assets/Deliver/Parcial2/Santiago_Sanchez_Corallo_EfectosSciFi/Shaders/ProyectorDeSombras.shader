...
Shader "ProyectorDeSombras"
{
	Properties
	{
		_ShadowTex1("ShadowTex", 2D) = "white" {}
		_FalloffTex1("FalloffTex", 2D) = "white" {}
		_MaskPower3("MaskPower", Float) = 4
		_MaskIntensity2("MaskIntensity", Float) = 6
	...
	LOD 0
		...
		Pass
		{
			...
			uniform float _MaskPower3;
			uniform float _MaskIntensity2;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 tex2DNode12 = tex2D( _ShadowTex1, ( (vertexToFrag5).xy / (vertexToFrag5).w ) );
				...
				float GradientTextureAlpha22 = tex2D( _FalloffTex1, ( (vertexToFrag10).xy / (vertexToFrag10).w ) ).a;
				float temp_output_27_0 = step( 0.001 , pow( GradientTextureAlpha22 , _MaskPower3 ) );
				float AlphaTextureIntensity32 = ( ( GradientTextureAlpha22 * temp_output_27_0 ) * ( temp_output_27_0 * _MaskIntensity2 ) );
...
/*ASEBEGIN
Version=18900
763;73;832;546;2095.512;554.4597;1.475291;False;False
...
Node;AmplifyShaderEditor.SamplerNode;19;-920.4056,130.7405;Inherit;True;Property;_FalloffTex1;FalloffTex;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-1106.783,740.7617;Inherit;False;Property;_MaskPower3;MaskPower;2;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-674.6684,955.7482;Inherit;False;Property;_MaskIntensity2;MaskIntensity;3;0;Create;True;0;0;0;False;0;False;6;6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-920.4056,-253.2595;Inherit;True;Property;_ShadowTex1;ShadowTex;0;0;Create;True;0;0;0;False;0;False;-1;None;84508b93f15f2b64386ec07486afc7a3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;18;17.15274,-85.3902;Float;False;Constant;_Vector1;Vector 0;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CA4375DAFE3D1F8153B1793DC2A87FB59A087ADB