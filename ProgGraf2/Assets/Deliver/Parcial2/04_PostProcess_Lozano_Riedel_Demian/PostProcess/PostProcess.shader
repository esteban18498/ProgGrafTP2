	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_CenterVector.y).xx;
				float smoothstepResult10 = smoothstep( _StepValueVector.x , _StepValueVector.y , length( ( texCoord6 - temp_cast_0 ) ));
...
/*ASEBEGIN
Version=18900
0;716;1569.6;275.8;1207.594;517.395;1.90895;True;False
...
ASEEND*/
//CHKSM=86373955F338CA8C51610305239B5F085500A8F1