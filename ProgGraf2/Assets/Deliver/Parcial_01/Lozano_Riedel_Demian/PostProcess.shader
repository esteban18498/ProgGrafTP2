...
Shader "PostProcess"
{
	...
	SubShader
	{
		...
		{ 
			...
			uniform float4 _EffectTexture_ST;
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float2 uv_EffectTexture = i.uv.xy * _EffectTexture_ST.xy + _EffectTexture_ST.zw;
				float4 color80 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float4 temp_output_82_0 = ( tex2D( _EffectTexture, uv_EffectTexture ).g * color80 );
				float2 texCoord6 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode2 = tex2D( _MainTex, texCoord6 );
				float4 lerpResult84 = lerp( temp_output_82_0 , tex2DNode2 , 0.5);
				

				finalColor = lerpResult84;
...
/*ASEBEGIN
Version=18900
-8;715.6;1569.6;431;-436.2957;618.6052;1;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;60;328.5819,-809.7617;Inherit;True;Property;_EffectTexture;EffectTexture;3;0;Create;False;0;0;0;False;0;False;a40a72d11e9194e42bad80f3397725a5;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.CommentaryNode;17;-293.8217,-394.5321;Inherit;False;1370.855;733.9206;Vignette;11;6;4;1;2;8;7;9;11;10;13;59;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;80;730.1798,-554.1561;Inherit;False;Constant;_Color0;Color 0;5;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;78;630.2515,-793.6945;Inherit;True;Property;_TextureSample5;Texture Sample 5;4;0;Create;True;0;0;0;False;0;False;60;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;71;1140.921,-375.006;Inherit;False;Constant;_Float5;Float 5;4;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;1003.924,-785.9393;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;59;839.4063,-201.5456;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;84;1416.586,-695.355;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;65;1476.68,-309.8554;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;4;519.2598,-166.6785;Inherit;False;Property;_ColorMult;Color;0;0;Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleTimeNode;64;1161.566,-865.1866;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;38;-3069.803,-359.1769;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;63;1328.573,-1026.628;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=FCC9D645C756B141AA1682C46D6543F1657024DA